...
public class AddEvent
{
    ...
    public static void DoAddEvent()
    {
        UnityEngine.Object[] objs = Selection.GetFiltered(typeof(AnimationClip), SelectionMode.Unfiltered);
        if (objs.Length < 2)
            return;
    ...
    public static void DoAddEventClip(AnimationClip sourceAnimClip, AnimationClip targetAnimClip)
    {
    ...
    public static void DoAddEventImportedClip(AnimationClip sourceAnimClip, AnimationClip targetAnimClip)
    {
